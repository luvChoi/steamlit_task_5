...
ax.plot(df["ds"], df["y"], color='blue', marker='o', markersize=4, linewidth=1.5, label='Actual')
ax.plot(forecast["ds"], forecast["yhat"], color='red', linestyle='--', linewidth=1.5, label='Predicted')
...
ax2.plot(merged["ds"], merged["residual"], color='purple', marker='o', linewidth=1.5, markersize=5, label='Residual')
